...
Striatum is an OOP, [composer-enabled][2], package, that implements [Observer pattern][3] to manage WordPress hooks. It takes the two pattern interfaces, [Subject][4] and [Observer][5], from PHP SPL library.
